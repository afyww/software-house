...
function Review() {
  return (
    <div className='grid grid-cols-1 bg-gradient-to-tr from-black to-amber-600'>
    <div className="my-64 xl:my-64 2xl:my-80">
        <div className="xl:order-1 mx-5 xl:mx-32 order-2 space-y-5 xl:space-y-10 2xl:space-y-16">
            <div className="w-full">
                <h1 className="text-2xl text-center xl:text-left xl:text-6xl 2xl:text-7xl text-white  font-medium">Review</h1>
