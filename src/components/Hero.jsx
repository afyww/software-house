            ...
            <div className="my-64 xl:my-64 2xl:my-80  xl:flex justify-between">
                ...
                <div className="xl:order-1 mx-5 xl:mx-32 order-2 space-y-5 xl:space-y-10 2xl:space-y-16">
                    <div className="w-full">
                        <h1 className="text-2xl text-center xl:text-left xl:text-6xl 2xl:text-7xl text-white  font-medium">Digitalize</h1>
                        <h1 className="text-2xl text-center xl:text-left xl:text-6xl 2xl:text-7xl text-amber-500  font-medium">Your Brand And</h1>
                        <h1 className="text-2xl text-center xl:text-left xl:text-6xl 2xl:text-7xl text-white font-medium">Connect The World.</h1>
                    </div>
