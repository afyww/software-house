                    ...
                    <div className="grid xl:grid-cols-2">
                        ...
                        <div className="p-4 my-auto">
                            <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
                                <div className="bg-white bg-opacity-20 space-y-5 p-8 xl:p-8 rounded-3xl">
                                    <div className="text-center">
                                        <h1 className="text-5xl xl:text-6xl font-extrabold text-white">100+</h1>
                                    </div>
                                    <div className="mx-auto text-center">
                                        <p className="text-white text-xl font-extralight">Total Projects Complete</p>
                                    </div>
                                </div>
                                <div className="bg-black bg-opacity-20 space-y-5 p-8 xl:p-8 rounded-3xl">
                                    <div className="text-center">
                                        <h1 className="text-5xl xl:text-6xl font-extrabold text-white">200+</h1>
                                    </div>
                                    <div className="mx-auto text-center">
                                        <p className="text-white text-xl font-extralight">Total Happy Customers</p>
                                    </div>
                                </div>
                                <div className="bg-black bg-opacity-20 space-y-5 p-8 xl:p-8 rounded-3xl">
                                    <div className="text-center">
                                        <h1 className="text-5xl xl:text-6xl font-extrabold text-white">18+</h1>
                                    </div>
                                    <div className="mx-auto text-center">
                                        <p className="text-white text-xl font-extralight">Lorem ipsum dolor sit amet, consectetur</p>
                                    </div>
                                </div>
                                <div className="bg-white bg-opacity-20 space-y-5 p-8 xl:p-8 rounded-3xl">
                                    <div className="text-center">
                                        <h1 className="text-5xl xl:text-6xl font-extrabold text-white">4+</h1>
                                    </div>
                                    <div className="mx-auto text-center">
                                        <p className="text-white text-xl font-extralight">Years Experience</p>
                                    </div>
                                </div>
                            </div>
                        </div>
